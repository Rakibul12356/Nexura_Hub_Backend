...
func SetupServer(cfg ServerConfig) *gin.Engine {
	...
	api := cfg.Engine.Group("/api/v1")
	{
		...
		api.GET("/courses/:id/enrollments", append(studio, cfg.PaymentHandler.CourseEnrollments)...)
		...
		api.PUT("/courses/:id/modules/reorder", jwtMw, cfg.CourseHandler.ReorderModules)
		...
		api.PUT("/modules/:id/lessons/reorder", jwtMw, cfg.CourseHandler.ReorderLessons)

		api.GET("/lessons/:id", optJwt, cfg.CourseHandler.GetLesson)
		...
		api.PATCH("/lessons/:id/complete", jwtMw, cfg.PaymentHandler.CompleteLesson)
		api.POST("/lessons/:id/resources", jwtMw, cfg.CourseHandler.AddResource)
		api.DELETE("/lessons/:id/resources/:resourceId", jwtMw, cfg.CourseHandler.DeleteResource)
		api.GET("/lessons/:id/notes", jwtMw, cfg.CourseHandler.GetNotes)
		api.POST("/lessons/:id/notes", jwtMw, cfg.CourseHandler.AddNote)
		api.DELETE("/lessons/:id/notes/:noteId", jwtMw, cfg.CourseHandler.DeleteNote)
		api.GET("/lessons/:id/discussions", jwtMw, cfg.CourseHandler.GetDiscussions)
		api.POST("/lessons/:id/discussions", jwtMw, cfg.CourseHandler.AddDiscussion)
		...
		api.GET("/quizzes/:id", jwtMw, cfg.QuizHandler.Get)
		api.POST("/quizzes", append(studio, cfg.QuizHandler.Create)...)
		api.PUT("/quizzes/:id", append(studio, cfg.QuizHandler.Update)...)
		api.DELETE("/quizzes/:id", append(studio, cfg.QuizHandler.Delete)...)
		api.POST("/quizzes/:id/questions", append(studio, cfg.QuizHandler.AddQuestion)...)
		api.DELETE("/quizzes/:id/questions/:qId", append(studio, cfg.QuizHandler.DeleteQuestion)...)
		api.POST("/quizzes/:id/submit", jwtMw, cfg.QuizHandler.Submit)
